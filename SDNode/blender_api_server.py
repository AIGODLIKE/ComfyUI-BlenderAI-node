...
def run_api_handler_server(port_range=BLENDER_IO_PORT_RANGE):
    server = SubThreadAPIServer(port_range=port_range, request_handler_class=APIHandler)
    server.run()


if __name__ == "__main__":
    run_api_handler_server((8000, 53824))
    import time
    time.sleep(10)
