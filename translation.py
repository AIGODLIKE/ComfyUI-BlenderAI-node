...
"Searge": "Sear节点",
    ...
    # File
        "SeargeImageSave": "Sear图像保存",
            "state": "状态",
            "save_to": "保存到",
                "output folder": "输出路径",
                "input folder": "输入路径",
    "FlowControl": "控制",
        "SeargeLatentMuxer3": "Sear切换Latent",
        "SeargeConditioningMuxer5": "Sear切换条件",
            "output": "输出",
            "input_selector": "选择",
            "input0": "输入0",
            "input1": "输入1",
    ...
    # UI
        # Input
            ...
            "SeargeInput2": "Sear采样",
                "image_width": "宽度",
                "image_height": "高度",
            "SeargeInput3": "SearSDXL",
                "refiner_strength": "优化力度",
                "refiner_intensity": "优化强度",
                    "hard": "强烈",
                    "soft": "柔和",
            ...
            "SeargeInput5": "Sear条件权重",
                "base_conditioning_scale": "基础条件缩放",
                "refiner_conditioning_scale": "优化条件缩放",
                "style_prompt_power": "风格力度",
                "negative_prompt_power": "负面风格力度",
                "style_template": "风格模板",
                    "test": "测试",
            "SeargeInput6": "Sear高清修复",
                "hires_fix": "高清修复",
                "hrf_steps": "步数",
                "hrf_denoise": "降噪",
            ...
            "SeargeInput7": "SearLora",
                ...
                "prompt_style": "风格提示词",
                    ...
                    "weighted": "权重",
        # output
            "SeargeOutput1": "Sear文本",
                "parameters": "参数组",
            "SeargeOutput2": "Sear采样",
            "SeargeOutput3": "SearSDXL",
            "SeargeOutput4": "Sear模型",
            "SeargeOutput5": "Sear条件权重",
            "SeargeOutput6": "Sear高清修复",
            "SeargeOutput7": "SearLora",
        # generate
            "SeargeGenerated1": "Sear生成",
                "operation_selector": "操作选择",
                "style_selector": "风格选择",
        "SeargeParameterProcessor": "Sear参数处理器",
}
VextraNode = {
...
for extension in extensions:
    lang_text["zh_CN"].update(extension)
