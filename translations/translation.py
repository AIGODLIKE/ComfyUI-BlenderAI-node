...
other = {
    ...
    "Open the selected Save/Preview/Input Image node's image in an Image Editor": "在图像编辑器中打开选定的保存/预览/输入图像节点的图像",
    ...
    "Move the current image to a ComfyUI Node Editor node": "将当前图像移动到 ComfyUI 节点编辑器节点上",
