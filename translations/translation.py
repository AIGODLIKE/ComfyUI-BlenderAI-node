...
other = {
    ...
    "Cannot connect to ComfyUI-CUP cup/clear_cache api.": "ComfyUI-CUP 连接失败.",
    "Cannot connect to ComfyUI-CUP cup/clear_vram api.": "ComfyUI-CUP 连接失败.",
    "Cannot connect to Blender-IO bio/fetch/comfyui_queue api.": "Blender-IO 连接失败.",
    "Submit Task": "提交任务",
    ...
    "Dependency error detected, please check if the dependency is installed correctly": "检查到依赖错误, 请检查依赖是否正确安装",
    "Dependency Installation": "依赖安装",
    "Installation tutorial for different launch methods:": "对不同的启动方式, 请参考以下教程:",
    "Launch Type: LocalServer": "启动类型: 本地启动",
    "1 Check the plugin directory SDNode/custom_nodes": "1 检查插件目录的SDNode/custom_nodes",
    "    1.1 Check if Blender-IO is included": "    1.1 检查是否包含 Blender-IO",
    "    1.2 Check if ComfyUI-CUP is included": "    1.2 检查是否包含 ComfyUI-CUP",
    "2 Go to follow url and re-install the plugin if missing": "2 缺少任何一个转跳 git 重新安装插件",
    "Blender-IO is missing, please re-install or update the plugin": "Blender-IO缺失, 请重装或更新插件",
    "ComfyUI-CUP is missing, please re-install or update the plugin": "ComfyUI-CUP缺失, 请重装或更新插件",
    "Launch Type: RemoteServer": "启动类型: 服务直连",
    "Check ComfyUI/custom_nodes dependencies": "ComfyUI依赖插件检查",
    "1.1 Open ComfyUI/custom_nodes folder": "1.1 检查路径ComfyUI/custom_nodes",
    "1.2 Check if Blender-IO is included": "1.2 检查是否包含 Blender-IO",
    "1.3 Check if ComfyUI-CUP is included": "1.3 检查是否包含 ComfyUI-CUP",
    "Method 1: Via ComfyUI Extension Manager": "方式1: 使用扩展管理安装",
    "2.1 Launch ComfyUI": "2.1 启动ComfyUI",
    "2.2 Open web page of ComfyUI": "2.2 打开网页端界面",
    "2.3 Open the extension manager": "2.3 打开扩展管理功能",
    "2.4 Search for ComfyUI-CUP and install": "2.4 搜索 ComfyUI-CUP 并安装",
    "2.5 Search for Blender-IO and install": "2.5 搜索 Blender-IO 并安装",
    "2.6 Restart ComfyUI service": "2.6 重启ComfyUI服务",
    "2.7 Reconnect to ComfyUI via RemoteServer": "2.7 重新服务直连",
    "Method 2: Manual Installation": "安装方式2: 手动安装",
    "3.1 Download Blender-IO": "3.1 下载Blender-IO插件",
    "3.2 Download ComfyUI-CUP": "3.2 下载ComfyUI-CUP插件",
    "3.3 Unzip Blender-IO to the directory of step 1": "3.3 将Blender-IO解压到步骤1目录",
    "3.4 Unzip ComfyUI-CUP to the directory of step 1": "3.4 将ComfyUI-CUP解压到步骤1目录",
    "3.5 Restart ComfyUI service": "3.5 重启ComfyUI服务",
    "3.6 Reconnect to ComfyUI": "3.6 重新服务直连",
    # preference.py
    "Server Type": "服务类型",
    "LocalServer": "本机启动",
